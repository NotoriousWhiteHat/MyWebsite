...
const ProjectCard = ({ title, image, visits, ccu, role, gameLink, groupLink }: ProjectCardProps) => {
  ...
  // Reset flip state when tab loses focus (e.g. after clicking a link that opens a new tab)
  useEffect(() => {
  ...
  return (
    <div
      ...
      role="button"
      aria-label={title}
      className="card-perspective relative group w-full aspect-[4/3] md:aspect-video transition-all duration-500 ease-out transform-gpu hover:scale-[1.02] hover:shadow-[0_8px_30px_rgba(0,0,0,0.5)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#4a9eff]/60 rounded-2xl"
    ...
    >
      ...
      >
              ...
              <div className="relative z-10 w-full bg-black/25 backdrop-blur-[2px] border border-white/10 rounded-xl p-3 md:p-4 flex items-center justify-between transition-all duration-500 ease-out group-hover:bg-black/35 group-hover:border-white/20 group-hover:translate-y-0 translate-y-1 group-hover:shadow-[0_-4px_20px_rgba(0,0,0,0.3)]">
                ...
                <div className="flex items-center gap-2.5 md:gap-4 shrink-0">
                  ...
                  <div className="flex items-center gap-1" aria-label={`Peak CCU: ${ccu}`}>  
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5 md:w-5 md:h-5 text-white" aria-hidden="true">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg, #18181b 85%, #1a1a2e 100%)",
            pointerEvents: isFlipped ? "auto" : "none",
          }}
        >
          {/* Subtle blue glow accents */}
          <div className="pointer-events-none absolute -bottom-10 -right-10 w-44 h-44 bg-[#4a9eff] rounded-full blur-[70px] opacity-10 z-0" />
          <div className="pointer-events-none absolute -top-8 -left-8 w-32 h-32 bg-[#4a9eff] rounded-full blur-[60px] opacity-5 z-0" />
          ...
          <div className="relative z-10 h-full w-full p-4 md:p-5 flex flex-col">
            ...
            <div className="flex items-center gap-4 mt-3">
              <div className="flex items-center gap-2" aria-label={`Peak CCU: ${ccu}`}>  
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 md:w-5 md:h-5 text-[#4a9eff] shrink-0" aria-hidden="true">
                  <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" />
                </svg>
                <div>
            ...
            <div className="flex items-center gap-2 mt-3">
              ...
              <a
                ...
                className="relative z-50 flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg bg-[#4a9eff] hover:bg-[#6aaeff] text-white font-bold text-xs md:text-sm transition-all duration-200 hover:shadow-[0_0_18px_rgba(74,158,255,0.45)] cursor-pointer"
              >
              ...
              {groupLink && (
                <a
                  ...
                  onClick={(e) => e.stopPropagation()}
                  onMouseDown={(e) => e.stopPropagation()}
                  className="relative z-50 flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg border border-[#4a9eff]/50 hover:border-[#4a9eff] text-[#4a9eff] font-bold text-xs md:text-sm transition-all duration-200 hover:bg-[#4a9eff]/10 cursor-pointer"
                >
                  <svg viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5 md:w-4 md:h-4 shrink-0" aria-hidden="true">
